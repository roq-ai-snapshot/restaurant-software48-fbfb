...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Restaurants', path: '/restaurants', icon: FiHome },
  { name: 'Menu Categories', path: '/menu-categories', icon: FiList },
  { name: 'Menu Items', path: '/menu-items', icon: FiClipboard },
  { name: 'Staff', path: '/staff', icon: FiUsers },
  { name: 'Reservations', path: '/reservations', icon: FiCalendar },
